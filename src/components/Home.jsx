...
// import imgs from "../assets3/imgs.jpg";
// import imgy from "../assets3/imgy.png";
// import imgv from "../assets3/imgv.jpg";
// import imgr from "../assets3/imgr.jpg";
...
{/* ----------------------------------------------------------------------------------------------------------------------------- */}
      ...
      <div className="home6" id="blogs">
        
        <div>
            <HashLink to="https://play.unity.com/mg/other/vr-meeting-room-1" className="link"><span>For Virtual Meet Room Click Here !!</span><img src={img21} alt= "Img" /></HashLink>
        </div>
